 ...
 * Re-exports from organized definitions/ directory for backward compatibility
 *
 * @deprecated Import from './definitions/index.js' instead
 * @module widgets-static
 */

// Import and re-export from new organized structure
import {
  availableApps as importedApps,
  availableWidgetsOnly as importedWidgetsOnly,
  availableWidgets as importedWidgets
} from './definitions/index.js';

// Re-export
export const availableApps = importedApps;
export const availableWidgetsOnly = importedWidgetsOnly;
export const availableWidgets = importedWidgets;
...
export function getWidgetById(id) {
  return importedWidgets.find(w => w.id === id);
}
